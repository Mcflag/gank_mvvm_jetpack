...
import com.ccooy.mvvm.constant.CACHE_FOLDER
...
class GlideModule : AppGlideModule() {
    ...
    override fun applyOptions(context: Context, builder: GlideBuilder) {
        builder
            .setDiskCache(InternalCacheDiskCacheFactory(context, diskCacheFolderName(context), diskCacheSizeBytes()))
